...
<body>
 <form class="form-inline">
  <a class="btn btn-light" href="index.php" role="button">Accueil</a>
    
  </form>
    <div class="container-fluid">
        <h4 class="display-3  text-center" style="color:gray;"></h4>
        ...
        <form method="post" action="admin.php" id="form">
            ...
            <button type="submit" class="btn btn-light" name="submit" style="margin-left:20px;">Login</button>
